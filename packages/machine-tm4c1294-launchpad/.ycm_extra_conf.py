...
libDirs = []#["/home/seb/echronos/packages/machine-tm4c1294-launchpad/ti_libs"]

import pickle
inc_path_args = pickle.load( open( os.path.dirname( os.path.abspath( __file__ )) + '/../../ycm_prj_include_dump.p', 'rb') )
